...
The two known former-oracle disagreements are preserved as integration `test.fails` bugs: [[solver-v2-universal-refinement-false-sat]] and [[block-scoped-let-vc-parity-bug]]. They are solver/VC correctness blockers, not reasons to keep the Z3 adapter in the dependency graph.
...
- PRESERVES → [[solver-v2-universal-refinement-false-sat]] — Former-oracle disagreement remains as integration test.fails bug

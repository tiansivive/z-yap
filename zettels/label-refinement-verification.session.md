...
**Outgoing**
- RESOLVED → [[checking-path-label-unbound]] — Elaboration self-referencing struct checking fixed
- RESOLVED → [[ivl-label-translation]] — Verification label translation fixed
- PRODUCED → [[verification-label-scope]] — Sibling-label scope invariant
- PRODUCED → [[record-refinement-false-valid.bug]] — Pre-existing discharge bug surfaced
- PRODUCED → [[label-context-trichotomy]] — Design concern noted

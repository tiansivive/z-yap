...
- Z3 has been removed after the temporary discrepancy harness findings were promoted into source-level integration parity tests. Former-oracle findings:
  - [[solver-v2-universal-refinement-false-sat]]: resolved/reframed by [[vc-validity-discharge]] for Yap's verification path; raw v2/Z3 disagreement remains a general quantified-SMT completeness limitation.
  ...
  The block-local-let case remains open because VC generation must be reviewed before solver-level parity is meaningful.
